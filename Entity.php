 ...
 * @link      http://github.com/kuldipem/php-mini-orm
 * @version   1.0.0
 *
 * @method int count ()
 * @method Entity ArrayBuilder()
 * @method Entity JsonBuilder()
 * @method Entity ObjectBuilder()
 ...
 * @method Entity query($query, $numRows = null)
 * @method Entity rawQuery($query, $bindParams = null)
 * @method Entity join(string $objectName, string $key, string $joinType, string $primaryKey)
 * @method Entity with(string $objectName)
 * @method Entity groupBy(string $groupByField)
 * @method Entity orderBy($orderByField, $orderbyDirection = "DESC", $customFieldsOrRegExp = null)
 * @method Entity where($whereProp, $whereValue = 'DBNULL', $operator = '=', $cond = 'AND')
 * @method Entity orWhere($whereProp, $whereValue = 'DBNULL', $operator = '=')
 * @method Entity having($havingProp, $havingValue = 'DBNULL', $operator = '=', $cond = 'AND')
 * @method Entity orHaving($havingProp, $havingValue = null, $operator = null)
 * @method Entity setQueryOption($options)
 * @method Entity setTrace($enabled, $stripPrefix = null)
 * @method Entity withTotalCount()
 * @method Entity startTransaction()
 * @method Entity commit()
 * @method Entity rollback()
 * @method Entity ping()
...
class Entity {
    ...
    public function __get ($name) {
        ...
        if (isset ($this->data[$name]) && $this->data[$name] instanceof Entity)
    ...
    private function prepareData () {
        ...
        foreach ($this->data as $key => &$value) {
            ...
            if ($value instanceof Entity && $value->isNew == true) {
                $id = $value->save();
                if ($id)
                    $value = $id;
                else
    ...
    public static function autoload ($path = null) {
        ...
        spl_autoload_register ("Entity::dbObjectAutoload");
    }
}